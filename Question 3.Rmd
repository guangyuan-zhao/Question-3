...
# Add normalized raw counts
	tab <- data.frame(tab, cpm(DGEList)[rownames(tab), ])
...
#### The output was also verified by another method which exported all significant genes for review and submission of my manuscript.