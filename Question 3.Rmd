...
# Add normalized raw counts
	tab <- cbind(tab, cpm(DGEList)[rownames(tab), ])
...
#### The output results were also verified with other method which generated significant gene list for downstream analysis.
